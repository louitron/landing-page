  ...
  const cards = [
    {
      ...
      bio: "Binky is a professional bubble wrap popper and unicorn whisperer. In their free time, they enjoy playing hopscotch with chickens.",
      imageURL:
    ...
    },
    {
      ...
      bio: "Chuckles is a world-renowned cheese sculptor and pogo stick enthusiast. They once broke the world record for most consecutive cartwheels.",
      imageURL:
        "https://i.insider.com/58d93bb6d349f92a008b734a?width=1000&format=jpeg&auto=webp",
    },
    {
      title: "Flapjack McFluffernutter",
      bio: "Flapjack is a part-time pirate and full-time pancake artist. They can juggle six flaming marshmallows without batting an eyelash.",
      imageURL:
